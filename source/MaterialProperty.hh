...
public:
   ...
   *
   */
  void set_powder_ratio_vector(dealii::LA::ReadWriteVector<double> src);

  /**
   *
   */
  void set_material_id_vector(
      dealii::LA::ReadWriteVector<dealii::types::material_id> src);
#endif
   ...
   *
   */
  void reinit_powder_ratio(unsigned int n_coefs);
  /**
   *
   */
  void reinit_material_id(unsigned int n_coefs);
#else
  /**
   *
   */
...
#ifdef ADAMANTINE_HAVE_CUDA
template <int dim>
inline void MaterialProperty<dim>::reinit_powder_ratio(unsigned int n_coefs)
{
  _powder_ratio.reinit(n_coefs);
}

template <int dim>
inline void MaterialProperty<dim>::reinit_material_id(unsigned int n_coefs)
{
...
#ifdef ADAMANTINE_HAVE_CUDA
template <int dim>
inline void MaterialProperty<dim>::set_powder_ratio_vector(
    dealii::LA::ReadWriteVector<double> src)
{
  _powder_ratio.import(src, dealii::VectorOperation::insert);
}

template <int dim>
inline void MaterialProperty<dim>::set_material_id_vector(
    dealii::LA::ReadWriteVector<dealii::types::material_id> src)
{
  _material_id.import(src, dealii::VectorOperation::insert);
}
#endif
